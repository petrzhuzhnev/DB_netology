...
select name_of_collections from collections where year_of_release between '2018-01-01' and '2021-01-01';
select nickname from executors where nickname not like ('% %');
select title_track from track where title_track like ('%Не%');
